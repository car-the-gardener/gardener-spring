...
<html lang="en">
  ...
  <body>
    ...
    <div class="body" style="margin-top: -70px">
          ...
          <div class="container">
            <div class="owl-carousel slide-one-item">
              ...
              <div class="d-md-flex testimony-29101 align-items-stretch">
                <div
                  class="image"
                  style="background-image: url('/resources/images/main3.png')"
                ></div>
                <div class="text">
                  <blockquote>
                    <p>
                      &ldquo; 어느날 우리는 같은 시간 다른 공간에서 같은 음악을
                      다른 기분으로 듣는다. 종착역 보다 늦게 도착한다. 선율만
                      흐를뿐이다.&rdquo;
                    </p>
            ...
            <div class="col-lg-4 col-md-6 my-lg-0 my-3">
              <div class="box bg-white">
                <div class="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://freepngimg.com/thumb/microphone/11-microphone-png-image-thumb.png"
                      alt=""
                    />
                  </div>
      ...
      <table cellspacing="0px" class="writing-list">
        <tr>
          ...
          <td>
            ...
            <h2>김인육</h2>
            <p>
              질량의 크기는 부피와 비례하지 않는다. 제비꽃같이 조그마한 그
              계집애가 꽃잎같이 하늘거리는 그 계집애가...
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <h2>나태주</h2>
            <p>
              예쁘지 않은 것을 예쁘게 보아주는 것이 사랑이다 좋지 않은 것을 좋게
              생각해주는 것이 사랑이다...
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <h2>오은영</h2>
            <p>
              어느날 우리는 같은 시간 다른 공간에서 같은 음악을 다른 기분으로
              듣는다....
            </p>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <h2>서덕준</h2>
            <p>
              하고많은 것들 중에 하필 당신을 사랑하였으나 그는 나에게 정차하는
              일이 없었다...
            </p>
          </td>
        </tr>
      ...
      <!-- card grid -->
      <div class="cardgrid"><%@ include file="./common/cardgrid.jsp" %></div>
    </div>
    <!-- body end -->
