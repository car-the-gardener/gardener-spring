		...
		<%@ include file="./common/header.jsp" %>
			<div class="body">
				<div class="right-dropdown">
					...
					</span> <input type="text" class="search-text" name="keyword" placeholder="검색어를 입력해주세요"> <input type="button"
						value="검색" class="search-button">
				</div>
				...
				<div class=search-body>
					...
					<table cellspacing="0px" class="writing-list">
						<tr>
							<td><a href="./post.html"> <img src="https://i.imgur.com/8OKpmst.jpg" class="writing-img"></td>
							</a>
							<td>
								<h2>사랑의 물리학 -</h2>
								<h3>김인육</h3>
