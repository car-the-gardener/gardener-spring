  ...
  <table cellspacing="0px" class="writing-list">
    ...
    <tr class="search-postnum" data-postnum="<%=recommend.getPostnum()%>">
      ...
      <td>
        ...
        <h2><%=recommend.getNickname() %>
        </h2>
        <p><%=recommend.getSubtitle() %>
        </p>
        <p class="recommend-content"><%=content%>
        </p>
      </td>
    </tr>
    </form>
      ...
      <ul class="cards">
        ...
        <li class="card">
          <div>
            ...
            <h3 class="card-title"><%=collection.getMaintitle() %>
            </h3>
            <p style="color:black;"><%=collection.getNickname() %>
            </p>
            <div class="card-content">
              <p style="color:black;"><%=collection.getSubtitle() %>
              </p>
            </div>
          </div>
