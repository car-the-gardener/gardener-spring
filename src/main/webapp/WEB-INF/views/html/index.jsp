    ...
    <body>
        ...
        <div class="body">
            <div class="right-dropdown">
                ...
                <input type="text" class="search-text" name="keyword" placeholder="검색어를 입력해주세요">
            ...
            <div class=search-body>
                <table class="main-table">
                    ...
                    <tr class="first-tr">
                        <td>
                            <a href="./post.html">
                                <img src="https://i.imgur.com/8OKpmst.jpg" class="first-img">
                            </a>
                        </td>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <a href="#">
                                        <img src="https://i.imgur.com/9dnYBV4.jpg" class="image">
                                    </a>
                                </tr>
                                <tr>
                                    <a href="#">
                                        <img src="https://i.imgur.com/Ms22sRJ.jpg" class="image">
                                    </a>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <a href="#">
                                        <img src="https://i.imgur.com/dDHB0Rk.jpg" class="image">
                                    </a>
                                </tr>
                                <tr>
                                    <a href="#">
                                        <img src="https://i.imgur.com/tyUPXLf.jpg" class="image">
                                    </a>
                                </tr>
                            </table>
                        </td>
                ...
                <table cellspacing="0px" class="writing-list">
                    ...
                    <tr>
                        <td><img src="https://i.imgur.com/J91Dzsg.jpg" class="writing-img"></td>
                        <td>
                            <h2>사랑에 답함 -</h2>
                            <h3>나태주</h3>
                            <p>예쁘지 않은 것을 예쁘게
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <h3>서덕준</h3>
                        <p>하고많은 것들 중에 하필 당신을 사랑하였으나
                            그는 나에게 정차하는 일이 없었다...
                        </p>
                    </td>
                </tr>
            </table>
            </div>  <!-- div class=" search-body" -->
            </div><!--div class="body"-->
            <!--body-->
